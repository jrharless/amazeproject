...
/**
 * Robot Class
 * Responsibilities: Turn, Direction, Rotate, Move, get Current Position,
 * set maze, is at exit, can see exit, is inside room, has room sensor, get current direction,
 * get battery level, set battery level, get energy for full rotation, get energy for step forward,
 * has stopped, distance to obstacle, has distance sensor
 *
 */
