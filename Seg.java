...
import falstad.MazePanel.panelcolor;
...
public class Seg {
	...
	Integer col; 	// color of segment, only set by constructor and file reader
	private boolean partition;
	private boolean seen; // if the segment has been seen by the user on its path through the maze
	//public MazePanel panel = new MazePanel();
	...
	private void initColor(int distance, int cc) {
		...
		//Globals.segpanel.assignColor(part2, rgbValue);
		//col = Globals.segpanel.getColor().getColor();
		switch (part2) {

			case 0: pcolor = new panelcolor(rgbValue, 20, 20); break;
			case 1: pcolor = new panelcolor(20, rgbValue, 20); break;
			case 2: pcolor = new panelcolor(20, 20, rgbValue); break;
			case 3: pcolor = new panelcolor(rgbValue, rgbValue, 20); break;
			case 4: pcolor = new panelcolor(20, rgbValue, rgbValue); break;
			case 5: pcolor = new panelcolor(rgbValue, 20, rgbValue); break;
			default: pcolor = new panelcolor(20, 20, 20); break;
		}
	}
	...
	public void storeSeg(Document doc, Element mazeXML, int number, int i) {
		...
		segpaint.setColor(Color.DKGRAY);
		MazeFileWriter.appendChild(doc, mazeXML, "colSeg_" + number+ "_" + i, segpaint.getColor()) ;
	}
	...
	public boolean equals(Object other){
		...
		if ((x != o.x) || (dx != o.dx) ||(y != o.y) || (dy != o.dy)) 
			return false ; 
		if ((dist != o.dist) || (partition != o.partition) ||(seen != o.seen) || (Globals.panel.getColor().getColor() != o.getColor()))
			return false ;
...
//	}
	...
	public void setColor(int color) {
		...
		Paint setpaint = new Paint();
		setpaint.setColor(color);
		Globals.panel.setColor(setpaint);
	}
